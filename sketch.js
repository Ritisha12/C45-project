...
function draw() {
  ...
  if(keyWentDown("space")){
    if(blockGroup.get(blockGroup.length-1).x === blockGroup.get(blockGroup.length-2).x){
     ...
     if(direction){
       if(blockGroup.get(blockGroup.length-1).x>blockGroup.get(blockGroup.length-2).x){
         breakOff=blockGroup.get(blockGroup.length-1).x-(blockGroup.get(blockGroup.length-1).x - blockGroup.get(blockGroup.length-2).x)
       }else{
        breakOff=blockGroup.get(blockGroup.length-1).x-(blockGroup.get(blockGroup.length-2).x - blockGroup.get(blockGroup.length-1).x)
